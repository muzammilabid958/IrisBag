...
class PopularProducts extends StatefulWidget {
  String name;
  PopularProducts({Key? key, required this.name}) : super(key: key);

  @override
  _PopularProductsState createState() => _PopularProductsState(this.name);
}

class _PopularProductsState extends State<PopularProducts> {
  late FeatureProduct product = new FeatureProduct(
    data: [],
  );
  int length = 0;
  bool loader = false;
  String name;
  _PopularProductsState(this.name);
  @override
  void initState() {
    super.initState();
  ...
  readJson() async {
    ...
    // final data = APIService.jsonfile();
    // getjson = widgetjson.fromJson(data);
    // setState(() {
    //   getjson = widgetjson.fromJson(data);
    // });
